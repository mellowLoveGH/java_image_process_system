...
public class ImgKMeans {
	...
	public static void main(String[] args) throws Exception {
		...
		path01 = "C:\\Users\\13418\\Desktop\\新建文件夹\\discussion\\img\\csy1.jpg";
		path02 = "C:\\Users\\13418\\Desktop\\新建文件夹\\discussion\\img\\csy";
...
//		kmeans(path01, 200, path02);
	...
	public static void init(String path01) {
		data = initData(dataIn(path01));
		initialRandC();
	}
	
	public static void kmeans(int k, String path02, boolean flag) {
		//初始化k个聚类
		initCenterCluster(k);
		int sum = 0;
		int j = 0;
	...
	public static void dataOut(String path, boolean flag) {
	...
	public static int[] imgRow;
	public static int[] imgCol;
	
	public static void initialRandC() {
		int r = data.length;
		int c = data[0].length;
		...
		for (int i = 0; i < c; i++) {
			...
			int c1 = (int) (Math.random() * c);
			int c2 = (int) (Math.random() * c);
			int swap = imgCol[c1];
			imgCol[c1] = imgCol[c2];
			imgCol[c2] = swap;
		}
